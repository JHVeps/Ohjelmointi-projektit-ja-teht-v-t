...
public class TRAI_21_X4_joniveps implements TRAI_21_X4 {
    /**
     * ITSEARVIOINTI    
     * Tämänkin tehävän tekemiseen tuli käytettyä tunteja paljon. Paperille yritin suunnitella niinkuin
     * oli ohjeistettu. Kuva sisäjärjestyksestä helpotti hahmottamista. jostain syystä yritin aluksi tehdä
     * aivan liian monimutkaista ratkaisua, kun  verrataan ratkaisuun mihin päädyin. Koen onnistumisen tunnetta 
     * siitä, että sain tehtyä testit läpäisevän algoritmin. Suunnitteluprosessi vaatii itseltäni vielä kehittämistä.
     * 
     * AIKAVAATIVUUS
