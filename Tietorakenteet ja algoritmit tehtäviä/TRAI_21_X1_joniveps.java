...
*Itsearviointi
*
*Tehtävässä testien läpäisevän metodin tekeminen ei ollut varsinaisesti vaikeaa.
*Vaikeaa oli ymmärtää mikä on paras mahdollinen ratkaisu.
*Useilla tavoilla sain tehtyä testiohjelman läpäisevän metodin, mutta en vielä osaa sanoa mikä niistä olisi ollut paras vaihtoehto.
*Päädyin valitsemaani ratkaisuun, koska mielestäni se on selkeä.
*Ohjelmoinnin kurssit olen läpäissyt kiitettävillä/erinomaisilla arvosanoilla siitä huolimatta koen, että asiat eivät ole vieläkään
*kovin hyvin hallussa.
*Aikavaativuuden laskeminen tuntuu vielä vaikealta ymmärtää. 
*
*/