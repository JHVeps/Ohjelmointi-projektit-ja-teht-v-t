...
public class PalveluViewController implements Initializable {
    ...
    private void addPalvelu(ActionEvent event) {
        if (nimiAddTextField.getText() == null || nimiAddTextField.getText().trim().isEmpty()) {
            ...
            Alert alert = new Alert(Alert.AlertType.ERROR, "Palvelu kenttä puuttuu tieto", ButtonType.OK);
            alert.getDialogPane().setMinHeight(Region.USE_PREF_SIZE);
            alert.setTitle("Palvelun tietojen lisäys");
            alert.setHeaderText("Virhe!");
            alert.show();
    ...
    private void modPalvelu(ActionEvent event) {
        ...
        if (palveluIdInfoTextField.getText() == null || palveluIdInfoTextField.getText().trim().isEmpty()) {
            ...
            Alert alert = new Alert(Alert.AlertType.ERROR, "Palvelun nimi kentta puuttuu tieto!", ButtonType.OK);
            alert.getDialogPane().setMinHeight(Region.USE_PREF_SIZE);
            alert.setHeaderText("Virhe!");
            alert.setTitle("Palvelun tietojen muokkaus");
            alert.show();
        } else if (hintaInfoTextField.getText() == null || hintaInfoTextField.getText().trim().isEmpty()) {
            Alert alert = new Alert(Alert.AlertType.ERROR, "Palvelun hinta kentta puuttuu tieto!", ButtonType.OK);
            alert.getDialogPane().setMinHeight(Region.USE_PREF_SIZE);
            alert.setHeaderText("Virhe!");
            alert.setTitle("Palvelun tietojen muokkaus");
            alert.show();
            ...
            Alert alert = new Alert(Alert.AlertType.ERROR, "Palvelun tyyppi kentta puuttuu tieto!", ButtonType.OK);
            alert.getDialogPane().setMinHeight(Region.USE_PREF_SIZE);
            alert.setHeaderText("Virhe!");
            alert.setTitle("Palvelun tietojen muokkaus");
            alert.show();
            ...
            Alert alert = new Alert(Alert.AlertType.ERROR, "Palvelun kuvaus kentta puuttuu tieto!", ButtonType.OK);
            alert.getDialogPane().setMinHeight(Region.USE_PREF_SIZE);
            alert.setHeaderText("Virhe!");
            alert.setTitle("Palvelun tietojen muokkaus");
            alert.show();
        } else if (toimipisteIdInfoTextField.getText() == null || toimipisteIdInfoTextField.getText().trim().isEmpty()) {
            Alert alert = new Alert(Alert.AlertType.ERROR, "Palvelun toimipisteId kentta puuttuu tieto!", ButtonType.OK);
            alert.getDialogPane().setMinHeight(Region.USE_PREF_SIZE);
            alert.setHeaderText("Virhe!");
            alert.setTitle("Palvelun tietojen muokkaus");
            alert.show();
    ...
    private void deletePalvelu (ActionEvent event) {
        ...
        if (palveluIdInfoTextField.getText() == null || palveluIdInfoTextField.getText().trim().isEmpty()) {
            ...
            try {
                 ...
                 */
                Tietokantayhteys.deleteAsiakas(conn, Integer.parseInt(palveluIdInfoTextField.getText()));
                /*
                 * Suljetaan tietokantayhteys
                 */
                Tietokantayhteys.closeConnection(conn);
